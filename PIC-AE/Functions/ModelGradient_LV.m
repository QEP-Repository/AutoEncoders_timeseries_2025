...
function [gradient,MSE,Physics] = ModelGradient_LV(parameters,AE,dlX_0,dlX_1,Noise,alpha,Model)
    

    [X0_p,Code0] = AE_network(dlX_0,[],1,parameters,AE,Noise);
    [X1_p,Code1] = AE_network(dlX_1,[],1,parameters,AE,Noise);
